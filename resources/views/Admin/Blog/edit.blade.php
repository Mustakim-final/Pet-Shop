                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('adminblog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{ $blog->title }}" id="exampleInputText" placeholder="Enter title">

                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputText">Date</label>
                                        <input type="date" class="form-control" name="date" value="{{ $blog->date }}" id="exampleInputText" placeholder="Enter sub title">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="description"  aria-label="With textarea">{{ $blog->description }}</textarea>
                                      </div>
